        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              <Link
                href="/dashboard"
                className="text-sm font-medium text-blue-600 hover:text-blue-700 px-4 py-2 border border-blue-100 hover:bg-blue-50 rounded-lg transition-colors"
              >
                Go to Dashboard
              </Link>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-10 leading-relaxed">
            Enter a keyword, and our automated workers will scrape the web to
            find high-quality company data and decision-maker emails for your
            sales pipeline.
          </p>
          <div className="flex justify-center gap-4">
            <Link
              href="/dashboard"
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-medium text-lg transition-all flex items-center gap-2 shadow-lg shadow-blue-600/20 hover:shadow-blue-600/40"
            >
